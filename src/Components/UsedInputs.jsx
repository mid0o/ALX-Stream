export const Message = ({ label, placholder }) => {
  return (
    <div className="text-sm w-full">
      <label className=" text-text font-semibold"> {label}</label>
      <textarea
...
export const Select = ({ label, options, onChange }) => {
  return (
    <>
      ...
      <select
        className="w-full mt-2 px-6 py-4 bg-main text-text border  border-border rounded "
        onChange={onChange}
      >
        {options.map((o, i) => (
